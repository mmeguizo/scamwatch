        ...
        if (!req.body.email) {
            ...
            if (!req.body.username) {
                ...
                if (!req.body.password) {
                    ...
                    Id.generate("user", async (uniqueID) => {
            ...
            User.updateOne({
                ...
                (err, user) => {
                    if (err) {
                        res.json({
                            success: false,
                            message: "Could not Deactivate User" + err,
                        });
                    } else {
                        res.json({
                            success: true,
                            message: data.username + " successfully Deactivated",
                            data: user,
                        });
            ...
            User.updateOne({
                ...
                (err, user) => {
                    if (err) {
                        res.json({
                            success: false,
                            message: "Could not Activate User" + err,
                        });
                    } else {
                        res.json({
                            success: true,
                            message: data.username + " successfully Activate",
                            data: user,
                        });
                        // globalconnetion.emitter('user')
                    }
        ...
        User.updateOne({
            ...
            (err, user) => {
                if (err) {
                    ...
                    res.json({
                        success: true,
                        message: data.username + " Successfully Deleted the User",
                        data: user,
                    });
                    // globalconnetion.emitter('user')
                }
